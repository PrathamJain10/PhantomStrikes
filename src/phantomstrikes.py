    ...
    def run(self):
        while self.running:
            while self.running:
                try:
                    if self.tor:
                        self.socks.set_proxy(socks.SOCKS5, '127.0.0.1', 9010)
                        time.sleep(1)
...
def usage():
    print("./phantomstrikes.py -t <target> [-r <threads> -p <port> -T -h]")
    ...
    print("Eg. ./phantomstrikes.py -t 192.168.1.100 -r 256\n")
...
if __name__ == "__main__":
    print("\n/*")
    print(" *"+term.RED + " Phantom Strikes "+term.NORMAL)
