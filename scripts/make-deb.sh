...
# Make Deb Package for PhantomStrikes (^.^)
_PACKAGE=phantomstrikes
_VERSION=2.3.5
_ARCH="all"
...
Maintainer: @htr-tech
Depends: ${_depend}
Homepage: https://github.com/PrathamJain10/PhantomStrikes
...
cp -fr ../web/.sites/ ../LICENSE.md ../README.md ../scripts/Phantom.sh ./build_env/$_opt_dir
