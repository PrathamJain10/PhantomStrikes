...
banner() {
	cat <<- EOF
		...
		${GREEN}[${WHITE}-${GREEN}]${CYAN} Tool Created by Pratham Jain and Team (Pratham.jain)${WHITE}
	EOF
}
...
banner_small() {
	cat <<- EOF
		...
		${BLUE}	 ______  _                    _                     
		${BLUE}	 | ___ \| |                  | |                    
		${BLUE}	 | |_/ /| |__    __ _  _ __  | |_  ___   _ __ ___   
		${BLUE}	 |  __/ | '_ \  / _` || '_ \ | |__/ _ \ | '_ ` _ \  
		${BLUE}	 | |    | | | || (_| || | | || |_| (_) || | | | | | 
		${BLUE}	 \_|    |_| |_| \__,_||_| |_| \__|\___/ |_| |_| |_| 
		${BLUE}	  _____  _          _  _                            
		${BLUE}	 /  ___|| |        (_)| |                           
		${BLUE}	 \ `--. | |_  _ __  _ | | __ ___  ___               
		${BLUE}	  `--. \| __|| '__|| || |/ // _ \/ __|              
		${BLUE}	 /\__/ /| |_ | |   | ||   <|  __/\__ \              
		${BLUE}	 \____/  \__||_|   |_||_|\_\\___||___/           ${WHITE} ${__version__}   
